$(function(){
  var questions = [
    ...
    { value: 'Does eating salmon impair judgement?', data: 'For most, consuming salmon does not impair cognition.  There are outliers whose lives have been destroyed by ingesting salmon.  NIH is currently working on a double blind study with a tasteless salmon and other taseteless fish.' },
